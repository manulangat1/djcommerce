  ...
  render() {
    ...
    const authLinks = (
      <ul>
        ...
        <li>
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <p>{`${
                this.props.cart && this.props.cart.orderItems.length
              } items`}</p>
              {this.props.cart &&
              ...
              {this.props.cart && this.props.cart.orderItems.length < 1 ? (
                <p>No items</p>
              ) : null}
              <button
        ...
        <li></li>
        <button onClick={this.props.logout} className="primary-btn">
          Logout
        </button>
      </ul>
    );
...
export default withRouter(
  connect(mapStateToProps, { logout, cartSuccess, loadCategory })(Header)
);
